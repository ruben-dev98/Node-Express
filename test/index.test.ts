...
describe('Booking Tests', () => {
    it('should not create a new booking and show a 401 Unauthorized error', async () => {
        ...
        expect(res.body).toMatchObject({message: "Unauthorized. The request lacks basic authentication", status: 401});
    });
    ...
    it('should create a new booking and show a 200 status with a successfully message', async () => {
        ...
        expect(res.body).toMatchObject({message: 'Booking #31 successfully added', status: 200});
    });
    ...
    it('should edit a booking and show a 200 status with a successfully message', async () => {
        ...
        expect(res.statusCode).toEqual(200);
        expect(res.body).toMatchObject({message: 'Booking #31 successfully edited', status: 200});
    });
    ...
    it('should delete a booking and show a 200 status with a successfully message', async () => {
        const res = await request(app)
            ...
            .set({authorization: token})
        expect(res.statusCode).toEqual(200);
        expect(res.body).toMatchObject({message: 'Booking #31 deleted successfully', status: 200});
    });
})
