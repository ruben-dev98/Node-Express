...
export const AmenityRoomsTable: Tables[] = [
    ...
    {name: 'amenity_id', type: 'INT UNSIGNED NOT NULL', foreign: 'FOREIGN KEY (amenity_id) REFERENCES amenity(_id) ON DELETE CASCADE', setValue: () => faker.number.int({min: 1, max: 14})},
];
